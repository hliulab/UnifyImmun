...
## Webserver: http://drug.hliulab.tech/unifylmmun/
...
>Output HLA-antigen-TCR pred scores:

`python ./source/out_score_triple.py --input ./data/data_HLA/HLA-antigen-TCR --output ./data/HLA-antigen-TCR_score`
