...
for fold in [1]:
    ...
    external_result_data = list(external_result_data_dict.values())

    independent_result_df = pd.DataFrame(independent_result_data)
    external_result_df = pd.DataFrame(external_result_data)
    # Save the DataFrame to a CSV file
    independent_result_df.to_csv('independent_result_data.csv', index=False)
    external_result_df.to_csv('external_result_data.csv', index=False)
